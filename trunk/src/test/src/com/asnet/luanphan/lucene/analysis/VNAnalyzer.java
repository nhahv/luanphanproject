package com.asnet.luanphan.lucene.analysis;
...
import com.asnet.luanphan.lucene.VietStopword;
import com.asnet.luanphan.vntokenizer.UseVnTokenizer;
...
public class VNAnalyzer extends Analyzer {
	...
	public TokenStream tokenStream(String fieldName, Reader reader){
		...
		try {
			lexerTokens = vietnameseToken.tokenize(reader);//"test\\dataTest\\data.txt"
